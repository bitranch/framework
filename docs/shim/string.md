...
```ts
import { codePointAt } from '@dojo-ng/framework/shim/string';
...
```ts
import { endsWith } from '@dojo-ng/framework/shim/string';
...
```ts
import { fromCodePoint } from '@dojo-ng/framework/shim/string';
...
```ts
import { includes } from '@dojo-ng/framework/shim/string';
...
```ts
import { repeat } from '@dojo-ng/framework/shim/string';
...
```ts
import { startsWith } from '@dojo-ng/framework/shim/string';
...
```ts
import { padEnd } from '@dojo-ng/framework/shim/string';
...
```ts
import { padStart } from '@dojo-ng/framework/shim/string';
